    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <Popcorn
          ...
          style={{ color: 'var(--accent-color)', width: 200, height: 200, opacity: isLight ? 0.06 : 0.04 }}
          strokeWidth={1}
        />
        <Film
          className="absolute bottom-[12%] left-[2%] -rotate-12"
          style={{ color: isLight ? 'var(--text-muted)' : 'white', width: 220, height: 220, opacity: isLight ? 0.04 : 0.03 }}
          strokeWidth={1}
        />
      </div>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                >
                  ...
                  <div
                    className="relative z-10 w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 group-hover:scale-105"
                  ...
                  <div className="relative z-10 flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span
                        className="text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded border opacity-40 group-hover:opacity-70 transition-opacity"
        ...
        <div className="lg:hidden">
          ...
          <div className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-black tracking-tighter uppercase mb-6" style={ts.textPrimary}>
              Ton profil{' '}
              <span className="inline-block px-2 shadow-xl" style={{ backgroundColor: 'var(--accent-color)', color: 'var(--text-inverse)' }}>
                cinéphile
              </span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="absolute right-0 top-0 bottom-0 w-3 transition-opacity duration-500"
                  style={{ backgroundImage: 'repeating-linear-gradient(to bottom, transparent, transparent 10px, var(--accent-color) 10px, var(--accent-color) 20px)', opacity: profileActive === 'genre' ? 0.2 : 0.08 }} />
                <div className="relative z-10">
